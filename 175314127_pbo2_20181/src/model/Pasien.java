...
import static model.Pasien.daftarPasiensKlinik;
/**
 *
 ...
 */
   ...
   public Pasien daftarPasienKlinik;
    public static  ArrayList<Pasien> daftarPasiensKlinik = new ArrayList<Pasien>();
 ...
 */
   ...
   public  static void tambahPasienBaru( Pasien pasien){
     daftarPasiensKlinik.add(pasien);
   }
   public  static Pasien cariPasien(String NoRM){
       for (int i = 0; i < daftarPasiensKlinik.size(); i++) {
           if (daftarPasiensKlinik.get(i).noRekamMedis == String) {
               return daftarPasiensKlinik.get(i);
           }
